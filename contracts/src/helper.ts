...
export function model(w: Matrix, b: Matrix, x: Matrix): Matrix {
...
export function floatToFixedQ1616(num: number): number {
  return Math.round(num * FIXED_POINT_SCALE_FACTOR);
}

// Convert Q16.16 fixed point to float
export function fixedQ1616ToFloat(num: number): number {
